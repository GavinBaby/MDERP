...
$(function () {
    ...
    $p_id.find("#build_q").val(temporary_bid);
    var init_frist = true;
    ...
    function into() {
        ...
        var aoColumnDefs = [{
            ...
            "html": function (data, type, full) {
                ...
                return  '<td><div class="text-left" style="font-size: 14px;"><input value="'+data+'" class="text-center" type="checkbox" style=" margin-left:25px "></div></td>';
            ...
            "colIndex": 10,
            "html": function (data, type, full) {
                return  '<td><div class="drop-opt"><a class="employee_edit"  href="javascript:void(0)"  data-id="'+full.seqNo+'" data-name="'+full.name+'" data-toggle="modal">抄表</a></div></td>';
            }
        }]; // 定义需要改变的列
