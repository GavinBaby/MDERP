...
$(function () {
    var $p_id = $("#regional_payment_page");
    var project_name = [];
    var project_no = [];
    var now = new Date();
    ...
    function init(){
        $.ajax({
            ...
            "timeout": 20000,
            "async": false,
            "url": sys_client+'/JCSW/web/publicmenus/Payment_mpay_ajax.action',
            "data": {p_id:sys_pId,areaId:$p_id.find("#area_q").val(),year:$p_id.find("#year_q").val()},
            "jsonp":"callback",
            "jsonpCaback":"handle",
            "success": function (data) {
                debugger;
