...
//查询（绘画表格）
    function into() {
        ...
        var ajax_url = '/soldamount/list'; // 定义数据请求路径 http://localhost:8080/JCSW/web/publicmenus/Area_List_ajax.action
        ...
        var aoColumnDefs = [{
            ...
            "html": function (data, type, full) {
                ...
                return  '<td><div class="text-center" style="font-size: 14px;">'+full.SNAME+'</div></td>';
            ...
            "html": function (data, type, full) {
                ...
                return  '<td><div class="text-center" style="font-size: 14px;">'+full.TNUM+'</div></td>';
            }
        },{
            "colIndex": 2,
            "html": function (data, type, full) {
                ...
                return  '<td><div class="text-center" style="font-size: 14px;">'+full.TMONEY+'</div></td>';
            }
        }]; // 定义需要改变的列
